...
import 'package:agenda/presentation/tasks/form/widgets/finance_link_card.dart';
    ...
    return ListView(
      ...
      children: [
        ...
        AdvancedOptionsCard(
          ...
          onToggle:
              () => onModelChanged(
                (m) => m.advancedExpanded = !m.advancedExpanded,
              ),
          ...
          children: [
            ScheduleFields(
              ...
              onRecurrenceChanged:
                  (v) => onModelChanged((m) => m.recurrenceRule = v),
            ),
            const FieldDivider(),
            FlagsSizeNotesFields(
              ...
              onImportantChanged:
                  (v) => onModelChanged((m) => m.isImportant = v),
              onSizeCategoryChanged:
                  (v) => onModelChanged((m) => m.sizeCategory = v),
            ),
          ],
        ),
        const SizedBox(height: 12),
