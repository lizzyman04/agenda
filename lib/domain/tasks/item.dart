...
export 'package:agenda/core/utils/copy_with_sentinel.dart';
export 'package:agenda/domain/tasks/item_copy_with.dart' show ItemCopyWith;
...
///
/// `copyWith` lives in `item_copy_with.dart` as an extension (see
/// `ItemCopyWith`) — every field below is public/final, so the extension
/// needs no private access and call sites are unchanged.
class Item {
  const Item({
    required this.id,
    required this.type,
