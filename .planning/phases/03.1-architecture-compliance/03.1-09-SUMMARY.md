...
requires:
  - phase: 03.1-architecture-compliance
    provides: precedent for the widgets/<entity>/ subfolder split pattern (established in earlier 03.1 plans)
provides:
  - Three finance list/overview screens split to ≤150 lines each
  - widgets/debt/, widgets/recurring/, widgets/budget/ per-entity subfolder convention for wave 2 plans (3.1-12–3.1-15) to add into
affects: [03.1-08, 03.1-10, 03.1-12, 03.1-13, 03.1-14, 03.1-15]
...
# Phase 03.1 Plan 09: Finance List/Overview Screen Widget Extraction Summary
...
- `widgets/debt/`, `widgets/recurring/`, and `widgets/budget/` subfolders now exist and are established for wave 2 plans (3.1-12–3.1-15) to add their own per-entity files into, keeping `presentation/finance/widgets/` root from exceeding the SC-2 10-file cap.
