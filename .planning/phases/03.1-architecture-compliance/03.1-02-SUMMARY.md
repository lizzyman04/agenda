...
requires:
  - phase: 03.1
    provides: "GTD guide already extracted from task_form_screen.dart (commits 6c06312/04c4f84, plan 3.1-01), leaving a 752-line screen"
provides:
...
# Phase 03.1 Plan 02: Task Form Screen Decomposition Summary
...
**Plan metadata:** (this commit, `docs(3.1-02): complete task form screen decomposition plan`)
