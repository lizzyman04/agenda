...
affects: [03.1-18 (CI enforcement of the architecture guard, once all phase plans land)]
...
key-decisions:
  - "Pattern 4 as literally described in 03.1-RESEARCH.md (continuing a class's method set across part/part-of files) is not valid Dart — Dart has no partial-class syntax; a class body must be complete in one file. Verified by a minimal compile test before implementing."
...
# Phase 03.1 Plan 05: Split item_dao.dart and item_repository_impl.dart Summary
...
**1. [Rule 3 - Blocking issue] Pattern 4 as literally specified in 03.1-RESEARCH.md is not valid Dart**
